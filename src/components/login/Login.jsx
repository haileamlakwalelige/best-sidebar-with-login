...
const Login = () => {
  return (
    <div className="h-screen w-screen bg-slate-800 -mt-20 pt-32">
      <form className="max-w-sm mx-auto mt-20 py-10 px-10 rounded-3xl  bg-gray-900">
        <div className="mb-5">
          <label
            for="email"
        ...
        <div className="flex items-start mb-5 mt-10">
          <label for="terms" className="ms-2 text-sm font-medium text-white ">
            Forget Password? <span className="text-blue-700 border-b-blue-700 border-b-2 hover:text-blue-900 hover:font-bold">Yes?</span>
          </label>
        </div>
      </form>
    </div>
